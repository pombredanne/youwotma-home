...
let self = liberator.plugins.smooziee = (function(){
  ...
  var PUBLICS = {
    smoothScrollBy: function(moment) {
      ...
      interval = parseInt(liberator.globalVariables.smooziee_scroll_interval || '16');
  ...
  function getScrollAmount() parseInt(liberator.globalVariables.smooziee_scroll_amount || '100');
